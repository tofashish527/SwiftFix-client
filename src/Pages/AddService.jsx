    ...
    <fieldset className="border rounded-md p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input type="text" id="imageUrl" name="serviceImage" placeholder="Image URL" className="input input-bordered w-full" required />
        </div>
        <div>
          <label className="block mb-1 text-sm font-medium" htmlFor="price">Price</label>
          <input type="number"  id="price" name="servicePrice" placeholder="Price" className="input input-bordered w-full" required />
        </div>
        <div>
          <label className="block mb-1 text-sm font-medium" htmlFor="area">Service Area</label>
          <input type="text" id="area" name="serviceArea" placeholder="Service Area" className="input input-bordered w-full" required />
        </div>
      </div>
    ...
    <fieldset className="border rounded-md p-4">
      <legend className="text-lg font-semibold mb-1">Service Provider Info</legend>
       <div className="mb-2">
        ...
        <input type="text" name='providerImage' id="providerPhoto" value={user?.photoURL||" "} readOnly className="input input-bordered w-full" />
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
